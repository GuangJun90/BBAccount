...
//        }
        ...
        //4:中心圆圈的半径
        [progressline moveToPoint:CGPointMake(xPosition+4, chartCavanHeight - grade * chartCavanHeight+UULabelHeight)];
        ...
        for (NSString * valueString in childAry) {
            ...
            if (index != 0) {
                ...
                [progressline addLineToPoint:CGPointMake(xPosition + index*(_xLabelWidth)-4, chartCavanHeight - grade * chartCavanHeight + UULabelHeight)];
...
//                    }
//                }
                [progressline moveToPoint:CGPointMake(xPosition+index*_xLabelWidth+4, chartCavanHeight - grade * chartCavanHeight+UULabelHeight)];
                [self addPoint:point
                         index:i
                        isShow:isShowMaxAndMinPoint
