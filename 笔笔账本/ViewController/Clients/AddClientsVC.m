...
@interface AddClientsVC ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate,ABPeoplePickerNavigationControllerDelegate>
...
- (IBAction)addBtnClicked:(id)sender {
    ClientsModel *clients = [ClientsModel new];
    ...
    clients.Img = imgdata;
    [ClientsViewModel saveModelToSQLWith:clients];
