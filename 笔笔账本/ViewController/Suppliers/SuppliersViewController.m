...
@interface SuppliersViewController ()<UITableViewDelegate,UITableViewDataSource,LXActivityDelegate>
/** 客户姓名列表 */
@property(nonatomic,strong) NSArray *suppliersNameArr;
/** 首字母索引 */
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    self.suppliersNameArr = [self.suppliersVm getSuppliersNameArray];
    self.firstKeyIndexArr = [ChineseContenr IndexArray:self.suppliersNameArr];
    self.sortArr = [ChineseContenr LetterSortSupplierModel:self.suppliersVm.suppliersArr];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SuppliersModel *model = self.sortArr[indexPath.section][indexPath.row];
